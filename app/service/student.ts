...
export const getStudentDetails = async (req: Request<{ student_rollno: string }>, res: Response) => {
    try {
...
export const searchStudent = async (req: Request<{ student_rollno: string }>, res: Response) =>{
    try {
        const studentRollNo = req.params.student_rollno;
        if (!studentRollNo) {
